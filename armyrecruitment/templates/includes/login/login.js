...
login.bind_events = function () {
	...
	$(".form-signup").on("submit", function (event) {
		event.preventDefault();
		var args = {};
		args.cmd = "armyrecruitment.core_modifications.user.sign_up";
		args.email = ($("#signup_email").val() || "").trim();
		args.mobile_no = ($("#signup_mobile").val() || "").trim();
	...
	$(".form-forgot").on("submit", function (event) {
		event.preventDefault();
		var args = {};
		args.cmd = "recruitment.core_modifications.user.reset_password";
